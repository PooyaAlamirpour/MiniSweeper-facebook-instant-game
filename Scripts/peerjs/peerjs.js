...
function (_super) {
  ...
  Peer.prototype.call = function (peer, stream, options) {
    ...
    if (this.disconnected) {
      ...
      this.emitError(enums_1.PeerErrorType.Disconnected, "Cannot connect to new Peer after disconnecting from server.0x9687");
      return;
    }
